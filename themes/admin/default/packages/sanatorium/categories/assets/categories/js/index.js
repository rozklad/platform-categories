...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'categories');

		$('.daterangepicker_end_input').attr('data-grid', 'categories');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('categories', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
