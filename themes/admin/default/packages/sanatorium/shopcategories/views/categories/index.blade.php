...
{{ Asset::queue('index', 'sanatorium/categories::categories/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="categories" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="categories" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="categories" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="categories" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="categories"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.categories.categories.grid') }}" data-grid="categories">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/categories::categories/model.general.id') }}}</th>
					<th>{{{ trans('sanatorium/categories::categories/model.general.category_title') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('sanatorium/categories::categories/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="categories"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/categories::categories/grid/index/results')
	@include('sanatorium/categories::categories/grid/index/pagination')
	@include('sanatorium/categories::categories/grid/index/filters')
	@include('sanatorium/categories::categories/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/categories::categories/help')
@endif
